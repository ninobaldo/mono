...
Malware é a junção das palavras em inglês \emph{malicious} e \emph{software}, termos em inglês que pode ser traduzido livremente como aplicativo malicioso. Dessa forma podemos considerar como malware os vírus, worms, trojans, botnets kit dentro outros, contudo o inverso não é valido, ou seja, todo vírus é um malware, mas nem todo malware é um vírus.
...
% botnet zombies
Uma \emph{botnet} é uma rede de computadores controlados por cybercriminosos\cite{KAS2013}. Basicamente quando um computador é infectado pelo agente da \emph{botnet} o mesmo se torna parte da rede e é controlado pelo dono da botnet. 

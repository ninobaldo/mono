...
% alterar partes nao significantes de todos os arquivos do computador, como a mensagem ja mostrada do PE alterar uma letra dessa mensagem muda o hash do mesmo cansando o perito :P

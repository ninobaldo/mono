...
Essas técnicas podem ser combinadas dificultando ainda mais a análise, contudo o stub tem a chave para decodificar o binário, mas isso pode ser mais dificil quando \emph{crypters} e \emph{packer} privado, pode dividir o código em diversos setores e cada setor ter uma chave criptogradada diferente SALT + HWID + TIME + PCI\_ROM para criar a chave
